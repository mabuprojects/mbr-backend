...
public class AddressDto {
	...
	public AddressDto(Long id, String country, String state, String city, String street, String number, String unity,
	...
	public String toString() {
		return "AddressDto [id=" + id + ", country=" + country + ", state=" + state + ", city=" + city + ", street="
